...
/**
 * Full-viewport, fixed snowfall layer that sits behind all page content.
 *
 * - Flakes fall continuously top -> bottom with gentle horizontal sway.
 * - Clicking/tapping anywhere bursts nearby flakes into smaller fragments
 *   that scatter outward and fall away under light gravity.
 * - Density scales with viewport size; respects prefers-reduced-motion.
 */
